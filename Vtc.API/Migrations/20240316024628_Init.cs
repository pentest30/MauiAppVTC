        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AdhereAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false),
                    DrivingPermitAttachment = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    Email = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OtpValidations_CustomerId",
                schema: "CustomerManagement",
                table: "OtpValidations",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_OtpValidations_DriverId",
                schema: "CustomerManagement",
                table: "OtpValidations",
                column: "DriverId");
